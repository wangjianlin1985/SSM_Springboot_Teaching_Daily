...
public class TeacherService {
    ...
    /*按照查询条件分页查询教师记录*/
    public ArrayList<Teacher> queryTeacher(String teacherNo,ClassInfo classObj,String name,String birthDate,String telephone,int currentPage) throws Exception { 
     	String where = "where 1=1";
    	if(!teacherNo.equals("")) where = where + " and t_teacher.teacherNo like '%" + teacherNo + "%'";
    	if(null != classObj &&  classObj.getClassNo() != null  && !classObj.getClassNo().equals(""))  where += " and t_teacher.classObj='" + classObj.getClassNo() + "'";
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Teacher> queryTeacher(String teacherNo,ClassInfo classObj,String name,String birthDate,String telephone) throws Exception  { 
     	String where = "where 1=1";
    	if(!teacherNo.equals("")) where = where + " and t_teacher.teacherNo like '%" + teacherNo + "%'";
    	if(null != classObj &&  classObj.getClassNo() != null && !classObj.getClassNo().equals(""))  where += " and t_teacher.classObj='" + classObj.getClassNo() + "'";
    	if(!name.equals("")) where = where + " and t_teacher.name like '%" + name + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String teacherNo,ClassInfo classObj,String name,String birthDate,String telephone) throws Exception {
     	String where = "where 1=1";
    	if(!teacherNo.equals("")) where = where + " and t_teacher.teacherNo like '%" + teacherNo + "%'";
    	if(null != classObj &&  classObj.getClassNo() != null && !classObj.getClassNo().equals(""))  where += " and t_teacher.classObj='" + classObj.getClassNo() + "'";
    	if(!name.equals("")) where = where + " and t_teacher.name like '%" + name + "%'";
