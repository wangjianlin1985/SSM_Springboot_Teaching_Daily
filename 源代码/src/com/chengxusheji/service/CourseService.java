...
public class CourseService {
    ...
    /*按照查询条件分页查询课程记录*/
    public ArrayList<Course> queryCourse(String courseNo,String courseName,Teacher teacherObj,ClassInfo classObj,String addTime,int currentPage) throws Exception { 
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<Course> queryCourse(String courseNo,String courseName,Teacher teacherObj,ClassInfo classObj,String addTime) throws Exception  { 
     	String where = "where 1=1";
    	if(!courseNo.equals("")) where = where + " and t_course.courseNo like '%" + courseNo + "%'";
    	if(!courseName.equals("")) where = where + " and t_course.courseName like '%" + courseName + "%'";
    	if(null != teacherObj &&  teacherObj.getTeacherNo() != null && !teacherObj.getTeacherNo().equals(""))  where += " and t_course.teacherObj='" + teacherObj.getTeacherNo() + "'";
    ...
    /*查询所有课程记录*/
    public ArrayList<Course> queryTeacherAllCourse(String teacherNo)  throws Exception {
        return courseMapper.queryCourseList("where 1=1 and t_course.teacherObj='" + teacherNo + "'");
    }
    

    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String courseNo,String courseName,Teacher teacherObj,ClassInfo classObj,String addTime) throws Exception {
     	String where = "where 1=1";
    	if(!courseNo.equals("")) where = where + " and t_course.courseNo like '%" + courseNo + "%'";
    	if(!courseName.equals("")) where = where + " and t_course.courseName like '%" + courseName + "%'";
    	if(null != teacherObj &&  teacherObj.getTeacherNo() != null && !teacherObj.getTeacherNo().equals(""))  where += " and t_course.teacherObj='" + teacherObj.getTeacherNo() + "'";
