...
<div id="course_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="courseQueryForm" method="post">
			...
			<input class="textbox" type="hidden" id="teacherObj_teacherNo_query" name="teacherObj.teacherNo" style="display:none;"/>
			<input class="textbox" type="hidden" id="classObj_classNo_query" name="classObj.classNo" style="display:none;"/>
...
<script type="text/javascript" src="Course/js/course_teacher_manage.js"></script> 
