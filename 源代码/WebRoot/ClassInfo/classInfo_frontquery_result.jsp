...
<%
    ...
    String bornDate = (String)request.getAttribute("bornDate"); //开办日期查询关键字
    String mainTeacher = (String)request.getAttribute("mainTeacher"); //班主任查询关键字
%>
<!DOCTYPE html>
<html>
<head>
...
<jsp:include page="../header.jsp"></jsp:include>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>班级编号</td><td>班级名称</td><td>开办日期</td><td>班主任</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="classInfoQueryForm" id="classInfoQueryForm" action="<%=basePath %>ClassInfo/frontlist" class="mar_t15" method="post">
			...
			<div class="form-group">
				<label for="bornDate">开办日期:</label>
				<input type="text" id="bornDate" name="bornDate" class="form-control"  placeholder="请选择开办日期" value="<%=bornDate %>" onclick="SelectDate(this,'yyyy-MM-dd')" />
			</div>
			<div class="form-group">
				<label for="mainTeacher">班主任:</label>
				<input type="text" id="mainTeacher" name="mainTeacher" value="<%=mainTeacher %>" class="form-control" placeholder="请输入班主任">
			</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="classInfo_bornDate_edit" class="col-md-3 text-right">开办日期:</label>
		  	 <div class="col-md-9">
                <div class="input-group date classInfo_bornDate_edit col-md-12" data-link-field="classInfo_bornDate_edit"  data-link-format="yyyy-mm-dd">
                    <input class="form-control" id="classInfo_bornDate_edit" name="classInfo.bornDate" size="16" type="text" value="" placeholder="请选择开办日期" readonly>
		  ...
		  <div class="form-group">
		  	 <label for="classInfo_classDesc_edit" class="col-md-3 text-right">班级备注:</label>
		  	 <div class="col-md-9">
			    <textarea id="classInfo_classDesc_edit" name="classInfo.classDesc" rows="8" class="form-control" placeholder="请输入班级备注"></textarea>
			 </div>
		  </div>
		</form> 
	...
	$.ajax({
		...
		success : function (classInfo, response, status) {
			if (classInfo) {
				...
				$("#classInfo_classDesc_edit").val(classInfo.classDesc);
