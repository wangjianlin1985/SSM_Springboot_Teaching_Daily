...
<div id="classInfo_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="classInfoQueryForm" method="post">
			...
			开办日期：<input type="text" id="bornDate" name="bornDate" class="easyui-datebox" editable="false" style="width:100px">
...
<div id="classInfoEditDiv">
	<form id="classInfoEditForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			...
			<span class="inputControl">
				<textarea id="classInfo_classDesc_edit" name="classInfo.classDesc" rows="8" cols="60"></textarea>
