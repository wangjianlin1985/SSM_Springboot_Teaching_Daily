...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">教学日常管理系统</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="<%=basePath %>index.jsp">首页</a></li>
                 <li><a href="<%=basePath %>ClassInfo/frontlist">班级查询</a></li>
                <li><a href="<%=basePath %>Student/frontlist">学生浏览</a></li>
                <li><a href="<%=basePath %>Teacher/frontlist">师资力量</a></li>
                <!-- 
                <li><a href="<%=basePath %>Task/frontlist">教师任务</a></li>
                <li><a href="<%=basePath %>Teach/frontlist">教学日历</a></li> -->
                <li><a href="<%=basePath %>Course/frontlist">课程列表</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
             	<%
				    ...
				    if(user_name==null){
	  			%> 
	  			<li><a href="<%=basePath %>Student/student_frontAdd.jsp"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;注册</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Teach/stuFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我的课表查询</a></li>
                        <li><a href="<%=basePath %>Student/student_frontSelfModify.jsp"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;修改个人资料</a></li>
                    </ul>
                </li>
