		       ...
		       text: "教师任务管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Task/task_add.jsp"
			    	   	},
			    		{
			    	   		text: "教师任务管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Task/task_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "课程管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Course/course_add.jsp"
			    	   	},
			    		{
			    	   		text: "课程管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Course/course_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "教学日历管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Teach/teach_add.jsp"
			    	   	},
			    		{
			    	   		text: "教学日历管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Teach/teach_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "新闻公告管理",
