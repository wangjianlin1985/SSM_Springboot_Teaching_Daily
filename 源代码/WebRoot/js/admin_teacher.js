			    	   ...
			    	   [
			    		{
			    	   		...
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Task/task_teacherQuery_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "课程管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Course/course_teacherAdd.jsp"
			    	   	},
			    		{
			    	   		text: "我的课程管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Course/course_teacherQuery_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "教学日历管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Teach/teach_teacherAdd.jsp"
			    	   	},
			    		{
			    	   		text: "我的教学日历管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Teach/teach_teacherQuery_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "新闻公告管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-edit",
			    		    url: "Teacher/teacher_selfModify.jsp"
			    	   	}
			    	   ]
			}],
