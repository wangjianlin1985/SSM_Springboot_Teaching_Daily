...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-12 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>Student/frontlist">学生管理</a></li>
		...
		<div class="row">
			<div class="col-md-10">
				  ...
				  <div class="form-group">
					 <label for="student_studentNo" class="col-md-2 text-right">学号:</label>
					 <div class="col-md-8"> 
					 	<input type="text" id="student_studentNo" name="student.studentNo" class="form-control" placeholder="请输入学号">
					 </div>
				  </div> 
				  <div class="form-group">
