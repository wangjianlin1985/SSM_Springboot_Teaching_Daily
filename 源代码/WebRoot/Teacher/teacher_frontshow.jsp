...
<div class="container">
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><%=teacher.getClassObj().getClassName() %></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">姓名:</div>
		<div class="col-md-10 col-xs-6"><%=teacher.getName()%></div>
	</div>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">性别:</div>
		<div class="col-md-10 col-xs-6"><%=teacher.getGender()%></div>
	</div>
	<div class="row bottom15"> 
